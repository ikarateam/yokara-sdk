...
#import "JSONModel.h"
@interface GetAllUserGiftsRequest : JSONModel
...
@property (strong, nonatomic) NSString *facebookId; //neu facebookId == null thi la lay qua cua User hien tai
