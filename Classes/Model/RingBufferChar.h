 ...
 */
#ifndef _RING_BUFFER_CHAR_H_
#define _RING_BUFFER_CHAR_H_

#include <stdlib.h>
#include <stdint.h>

typedef unsigned char ringbuf_t;	// Data type can be: char, int, long, float,...
