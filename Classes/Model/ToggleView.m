...
NSString *const TOGGLE_BUTTON_IMAGE      = @"toggle_button234.png";
NSString *const TOGGLE_BASE_IMAGE        = @"toggle_co_ban.png";
NSString *const TOGGLE_VIEW_BACKGROUND   = @"background.png";
NSString *const LEFT_BUTTON_IMAGE        = @"icn_vswitch_mo.png";
NSString *const LEFT_BUTTON_IMAGE_SEL    = @"icn_vswitch_mo.png";
NSString *const RIGHT_BUTTON_IMAGE       = @"icn_vswitch_tat.png";
NSString *const RIGHT_BUTTON_IMAGE_SEL   = @"icn_vswitch_tat.png";
...
@synthesize viewType,_leftButton,_rightButton;
   ...
   toggleButtonType:(ToggleButtonType)aButtonType
{
    ...
    if (self) {
        ...
        UIImageView *bgImageView = [[UIImageView alloc]initWithImage:
                                    [UIImage imageNamed:TOGGLE_VIEW_BACKGROUND inBundle:[YokaraSDK resourceBundle] compatibleWithTraitCollection:nil]];
       // [self addSubview:bgImageView];
        
        //set up toggle base image.
        _toggleBase = [[ToggleBase alloc]initWithImage:[UIImage imageNamed:TOGGLE_BASE_IMAGE inBundle:[YokaraSDK resourceBundle] compatibleWithTraitCollection:nil] baseType:aBaseType];
        ...
        _toggleButton = [[ToggleButton alloc]initWithImage:[UIImage imageNamed:TOGGLE_BUTTON_IMAGE inBundle:[YokaraSDK resourceBundle] compatibleWithTraitCollection:nil] buttonType:aButtonType];
        ...
        _leftEdge = _toggleBase.frame.origin.x + _toggleButton.frame.size.width/2+3;
        _rightEdge = _toggleBase.frame.origin.x + _toggleBase.frame.size.width - _toggleButton.frame.size.width/2-3;
        ...
        if (self.viewType == ToggleViewTypeWithLabel)
        {
            ...
            [_leftButton setImage:[UIImage imageNamed:LEFT_BUTTON_IMAGE inBundle:[YokaraSDK resourceBundle] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
            [_leftButton setImage:[UIImage imageNamed:LEFT_BUTTON_IMAGE_SEL inBundle:[YokaraSDK resourceBundle] compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
            ...
            [_rightButton setImage:[UIImage imageNamed:RIGHT_BUTTON_IMAGE inBundle:[YokaraSDK resourceBundle] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
            [_rightButton setImage:[UIImage imageNamed:RIGHT_BUTTON_IMAGE_SEL inBundle:[YokaraSDK resourceBundle] compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
...
- (void)onLeftButton:(id)sender
{
    [UIView animateWithDuration:TOGGLE_SLIDE_DULATION animations:^{
        _toggleButton.center = CGPointMake(_leftEdge, self.frame.size.height/2*1.2+1.5);
    }];
    if (self.viewType == ToggleViewTypeWithLabel)
    {
        _leftButton.selected = YES;
...
{
    [UIView animateWithDuration:TOGGLE_SLIDE_DULATION animations:^{
        _toggleButton.center = CGPointMake(_rightEdge, self.frame.size.height/2*1.2+1.5);
    }];
    if (self.viewType == ToggleViewTypeWithLabel)
    {
