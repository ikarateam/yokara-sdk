 ...
 */
RingBufferChar::RingBufferChar(uint16_t size)
{
 ...
 * 		   0 	Not empty.
 */
uint8_t RingBufferChar::isValid(void)
{
	if(pBuffer == 0)
		return 0;
 ...
 * 		   0 	Not empty.
 */
uint8_t RingBufferChar::isEmpty(void)
{
 ...
 */
uint16_t RingBufferChar::nextIndex(uint16_t index)
{
	if(buffer_size == 0)
		return 0;
 ...
 */
uint16_t RingBufferChar::prevIndex(uint16_t index)
{
	if(buffer_size == 0)
		return 0;
 ...
 * Return: None.
 */
void RingBufferChar::push(ringbuf_t value)
{
	if(buffer_size == 0)
		return;
 ...
 */
ringbuf_t RingBufferChar::pop(void)
{
	if(buffer_size == 0)
		return 0;
 ...
 */
uint16_t RingBufferChar::length(void)
{
	if(!isValid())
		return 0;
 ...
 * Return: ringbuf_t 	Read value.
 */
ringbuf_t RingBufferChar::valueHead(void)
{
	if(buffer_size == 0)
		return 0;
 ...
 * Return: ringbuf_t 	Read value.
 */
ringbuf_t RingBufferChar::valueTail(void)
{
	if(buffer_size == 0)
		return 0;
