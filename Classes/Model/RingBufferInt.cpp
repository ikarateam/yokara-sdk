 ...
 */
RingBufferInt::RingBufferInt(uint16_t size)
{
 ...
 * 		   0 	Not empty.
 */
uint8_t RingBufferInt::isValid(void)
{
	if(pBuffer == 0)
		return 0;
 ...
 * 		   0 	Not empty.
 */
uint8_t RingBufferInt::isEmpty(void)
{
 ...
 */
uint16_t RingBufferInt::nextIndex(uint16_t index)
{
	if(buffer_size == 0)
		return 0;
 ...
 */
uint16_t RingBufferInt::prevIndex(uint16_t index)
{
	if(buffer_size == 0)
		return 0;
 ...
 * Return: None.
 */
void RingBufferInt::push(ringbuf_t value)
{
	if(buffer_size == 0)
		return;
 ...
 */
ringbuf_t RingBufferInt::pop(void)
{
	if(buffer_size == 0)
		return 0;
 ...
 */
uint16_t RingBufferInt::length(void)
{
	if(!isValid())
		return 0;
 ...
 * Return: ringbuf_t 	Read value.
 */
ringbuf_t RingBufferInt::valueHead(void)
{
	if(buffer_size == 0)
		return 0;
 ...
 * Return: ringbuf_t 	Read value.
 */
ringbuf_t RingBufferInt::valueTail(void)
{
	if(buffer_size == 0)
		return 0;
